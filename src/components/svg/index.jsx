...
export const ArrowLeftLine = () => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M0 88V64H48V88 424l0 24H0l0-24V88zM135.6 273.5L117 256l18.6-17.5 136-128L289 94.1l32.9 35-17.5 16.4L212.5 232H296l128 0h24v48H424l-128 0H212.5l91.9 86.5L321.9 383l-32.9 35-17.5-16.4-136-128z"
      />
    </svg>
  );
};
const DiscoverIcon = ({ className }) => (
  <svg
    ...
    focusable="false"
    data-prefix="fak"
    className={`svg-inline--fa fa-google fa-fw fa-1x ${className}`}
    data-icon="discover"
    role="img"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 640 512"
  ...
  return (
    ...
    >
      <path
        ...
        className="stroke-textMain dark:stroke-textMain group-hover:stroke-primaryDuper transition-colors duration-300 stroke-[1.3px]"
        strokeMiterlimit="10"
      />
      <path
      ...
      <path
        ...
        className="stroke-textMain dark:stroke-textMain group-hover:stroke-primaryDuper duration-300 stroke-[1.3px] transition-all"
        strokeMiterlimit="10"
      />
      <path
        d="M14.5703 10.9004L24.0655 20.4041V24.4705H28.1405V10.9004H14.5703Z"
        className="stroke-textMain dark:stroke-textMain group-hover:stroke-primaryDuper stroke-[1.3px] transition-all duration-300"
        strokeMiterlimit="10"
      />
    </svg>
  );
};
export const MainLogoWithText = () => {
  return (
    <svg viewBox="0 0 151 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M24.0655 1.39844L14.5703 10.9021H24.0655V1.3984  4Z"
        className="stroke-primary dark:stroke-primary group-hover:stroke-primaryDuper transition-colors duration-300 stroke-[1.3px] transition-all duration-300"
        strokeMiterlimit="10"
      />
      <path
        d="M14.57 10.9021L5.07422 1.39844V10.9021H14.57Z"
      ...
      <path
        d="M5.07422 20.4041L14.57 10.9004V24.5252L5.07422 34.0288V20.4041Z"
        className="stroke-primary dark:stroke-primary group-hover:stroke-primaryDuper transition-colors duration-300 stroke-[1.3px]"
        strokeMiterlimit="10"
      />
      <path
        d="M1 10.9004V24.4705H5.07437V20.4041L14.5701 10.9004H1Z"
        className="stroke-primary dark:stroke-primary group-hover:stroke-primaryDuper duration-300 stroke-[1.3px] transition-all"
        strokeMiterlimit="10"
      />
      <path
        d="M14.5703 10.9004L24.0655 20.4041V24.4705H28.1405V10.9004H14.5703Z"
        className="stroke-primary dark:stroke-primary group-hover:stroke-primaryDuper stroke-[1.3px] transition-all duration-300"
        strokeMiterlimit="10"
      />
      <path
        ...
        className=" block fill-textMain dark:fill-textMain group-hover:fill-superDuper transition-colors duration-300"
      />
      <path
...
export const Discord = ({ className }) => {
  return (
    <svg
      ...
      data-prefix="fab"
      data-icon="discord"
      className={`svg-inline--fa fa-discord fa-fw fa-1x ${className}`}
      role="img"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 640 512"
    >
...
export const Twitter = ({ className }) => {
  return (
    <svg
      ...
      data-prefix="fab"
      data-icon="x-twitter"
      className={`svg-inline--fa fa-x-twitter fa-fw fa-1x ${className}`}
      role="img"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
    >
...
export const AppleIcon = ({ className }) => {
  return (
    <svg
      ...
      data-prefix="fab"
      data-icon="apple"
      className={`svg-inline--fa fa-apple fa-fw fa-1x ${className}`}
      role="img"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 384 512"
    >
...
export const EditIcon = ({ className }) => {
  return (
    <svg
      ...
      className={`svg-inline--fa fa-pen-to-square fa-fw fa-1x ${className}`}
      role="img"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
    >
...
export const LibraryIcon = ({ className }) => {
  return (
    <svg
      ...
      className={`svg-inline--fa fa-rectangle-vertical-history fa-fw ${className}`}
      role="img"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 576 512"
    >
